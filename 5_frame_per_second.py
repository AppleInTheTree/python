...
while running:
    dt = clock.tick(10) # 게임화면의 초당 프레임 수를 설정 처음에는 10으로 하기 화면의 움직임이 끊김이 없이 하기 위해서 more smooth screen

    #print( "fps : " + str(clock.get_fps()))
    # 캐릭터가 1초 동안에 100만큼 이동을 해야함
    #10 Fps : 1초 동안에 10번 동작 10 * 10
    #20 fps : 1초 동안에 20번 동작 5 * 20
    ...
    character_x_pos += to_x * dt # dt를 곱해주면 된다 fps를 바꿔도 같은 속도를 움직을수 있다.
